...
const contactSection = tv({
  slots: {
    root: [
      "relative scroll-mt-20 border-t border-border px-5 py-24",
      "bg-linear-to-b from-surface/20 to-surface/70 lg:px-10 lg:py-32",
    ],
    inner: "stage-panel mx-auto flex max-w-content flex-col items-start gap-8 p-7 lg:p-12",
    intro: "max-w-xl text-body-lg text-text",
    ...
    primary: [
      ...
      "bg-accent text-surface shadow-stage-card transition-all",
